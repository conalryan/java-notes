    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li><a href="/">Home</a></li>
                <li><a href="/form">Stock Quotes</a></li>
            </ul>
        </div><!--/.nav-collapse -->
    </div>
</nav>
...
<div class="jumbotron">
    ...
    <form action="yahoo/quotes/interval" method="get">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="stockSymbol" placeholder="Stock Symbol">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="until" placeholder="Until">
        </div>
        <div class="form-group">

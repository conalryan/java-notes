...
public class BasicStockQuoteApplication {
    ...
    public String displayStockQuotes(StockQuery stockQuery) throws StockServiceException {
        ...
        List<StockQuote> stockQuotes =
                stockService.getQuote(stockQuery.getSymbol(), stockQuery.getFrom(), stockQuery.getUntil(), stockQuery.getInterval());
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 4) {
            exit(ProgramTerminationStatusEnum.ABNORMAL,
                    "Please supply 4 arguments a stock symbol, a start date (yyyy/MM/dd), a end date (yyyy/MM/dd), and interval");
        }
        try {

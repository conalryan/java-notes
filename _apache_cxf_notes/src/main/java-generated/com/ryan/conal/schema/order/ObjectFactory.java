...
package com.ryan.conal.schema.order;
 ...
 * generated in the com.ryan.conal.schema.order package. 
...
public class ObjectFactory {
    ...
    private final static QName _OrderInquiryResponse_QNAME = new QName("http://www.conal.ryan.com/schema/Order", "orderInquiryResponse");
    private final static QName _OrderInquiry_QNAME = new QName("http://www.conal.ryan.com/schema/Order", "orderInquiry");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ryan.conal.schema.order
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.conal.ryan.com/schema/Order", name = "orderInquiryResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.conal.ryan.com/schema/Order", name = "orderInquiry")

package com.conal.ryan.cxfdemo.service;

import com.ryan.conal.schema.order.*;
...
public class DefaultOrderService implements OrderService {
    ...
    public OrderInquiryResponseType processOrder(int uniqueOrderId, int orderQuantity, int accountId, long ean13) {
        ...
        // It wraps the creation of schema objects that were also generated.
        // This factory should be used for all schema object creation.

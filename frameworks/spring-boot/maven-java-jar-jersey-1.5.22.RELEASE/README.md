...
```bash
./mvnw clean install
# Total Build Time: 9.084 s
```

## Test
```bash
./mvnw test
# Total Test Time: 2.410 s
```

## Run
```bash
./mvnw spring-boot:run
# Total Start Time: Aplication in 4.8 seconds (JVM running for 10.643)
```

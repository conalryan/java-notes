...
```bash
./mvnw clean install
Total Build Time: 21.982 s
```

```
08:35 $ ./mvnw dependency:tree
...
[INFO] Finished at: 2019-08-26T08:36:45-04:00
[INFO] ------------------------------------------------------------------------
```
...
# Total Start Time: Application in 5.709 seconds (JVM running for 17.314)
```
...
Heap Memory Usage: 65.7MB
Threads: 29
Classes: 9,339
CPU Usage: 0.1%

Select Memory tab and Perform GC
Heap Memory Usage: 34.6MB

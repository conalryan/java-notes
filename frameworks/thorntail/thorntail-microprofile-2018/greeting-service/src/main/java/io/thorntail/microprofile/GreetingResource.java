...
public class GreetingResource {
    ...
    // Set property via command line `java -Dname=Bob -jar target/my-thorntail.jar`
    private String name;
    ...
    @Timed // localhost:8080/metrics will now include metrics
    @Fallback(fallbackMethod = "greetingFallback")
    public Response greeting() throws Exception {
        NameService nameService = RestClientBuilder.newBuilder()

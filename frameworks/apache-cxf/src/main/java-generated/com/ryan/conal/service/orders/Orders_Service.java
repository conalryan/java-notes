 ...
 * 2017-08-10T15:40:55.226-04:00
 * Generated source version: 2.7.8
 * 
 */
@WebServiceClient(name = "Orders", 
                  wsdlLocation = "file:/Users/cryan/Development/github/conalryan/_apache_cxf_notes/src/main/resources/wsdl/Orders.wsdl",
                  targetNamespace = "http://www.conal.ryan.com/service/Orders/") 
public class Orders_Service extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://www.conal.ryan.com/service/Orders/", "Orders");
    public final static QName OrdersSOAP = new QName("http://www.conal.ryan.com/service/Orders/", "OrdersSOAP");
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/cryan/Development/github/conalryan/_apache_cxf_notes/src/main/resources/wsdl/Orders.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Orders_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/cryan/Development/github/conalryan/_apache_cxf_notes/src/main/resources/wsdl/Orders.wsdl");
        }
        WSDL_LOCATION = url;
    }
